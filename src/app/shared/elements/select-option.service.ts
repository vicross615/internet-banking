...
export class SelectOptionService {
  public static readonly PLAYER_ONE: Array<IOption> = [
    {value: '0', label: 'Link a New Account'},
    {value: '1', label: 'Jennifers Beauty and Spa (0089765432)'},
    {value: '2', label: 'Jennifer Olabani (0098765432)'},
    {value: '3', label: 'Yvonne Olabani (0012345678)'},
    {value: '4', label: 'SKS Joshua Olabani (7669493342)'}
  ];
